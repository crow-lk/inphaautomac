...
class GradeA extends ListRecords
{
    protected static string $resource = ModuleResource::class;

    protected static string $view = 'filament.resources.module-resource.pages.grade-a';

    protected function getTableQuery(): Builder
    {
        $startDate = Carbon::create(2025, 4, 7);
        return Module::query()->whereBetween('capacitance', [4000, 6000])
