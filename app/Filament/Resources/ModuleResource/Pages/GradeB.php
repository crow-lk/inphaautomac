...
class GradeB extends ListRecords
{
    protected static string $resource = ModuleResource::class;

    protected static string $view = 'filament.resources.module-resource.pages.grade-b';

    protected function getTableQuery(): Builder
    {
        $startDate = Carbon::create(2025, 4, 7);
        return Module::query()->whereBetween('capacitance', [3000, 4000])
