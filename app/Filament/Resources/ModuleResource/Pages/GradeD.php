...
class GradeD extends ListRecords
{
    protected static string $resource = ModuleResource::class;

    protected static string $view = 'filament.resources.module-resource.pages.grade-d';

    protected function getTableQuery(): Builder
    {
        $startDate = Carbon::create(2025, 4, 7);
        return Module::query()->whereBetween('capacitance', [1000, 2000])
